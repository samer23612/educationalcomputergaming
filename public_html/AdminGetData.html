...
<html>
<head>
	<title>Admin Portal - ECG - Search Results</title>
		...
		<div id="content" style="overflow:auto">
			...
			$searchDB = '';
			 ...
			 if($searchTitle != '' && $searchPub != '' && $searchSub != 'Any' && ($searchMinGrade != null || $searchMaxGrade != null)
			  ...
			  {
				 echo "<br><span style='color:red; font-weight:bold;'>Sorry, Unable to search database system. <br>Nothing was selected. Please <a href='ECG_AdminPortal.php' title='Search for Games' style='color:red; font-weight:bold;'>try again</a>!</span>";
			...
			function searchAll($searchDB)
			{
			  ...
			  print($PostAll);
				 ...
				 include ('AdminSearchResults.php');
				 //return $searchDB;
			}
