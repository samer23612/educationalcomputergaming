...
<head>
	...
	<title>ECG | Search for Games.html</title>
...
<div id="content" style="color: #00303A">
			<h2 style="color: #00303A">Search from over 1500 games available through 2016.</h2>
			If the search is not working, try <a href="http://hi3sites.com/ECG/Search_for_Games.php"><u></u>alternate search page</u></a>.
		
			<center>			
			<div ><!--Select or type in your criteria and then click on the Search button to see a list of educational computer games.<br><br>
				Click to search games at -> <a href="http://wingz2fly.com/wp/search/" target="_blank"><u>www.wingz2fly.com/wp/search</u></a>- <br><br>

                  Be sure the refresh happens for each search. List the games in the Window that will show all games when printed.<br><br>-->
			
				<FORM METHOD="post" ACTION="getData.php" name="search">
						 <table border="1" cellpadding="3" cellspacing="3" bordercolor="#000000">
						   <tr><td height="20" align="right" bgcolor="#FFFFFF">
						   &nbsp;<strong><font color="#00303A">Select All Titles</font></strong></td>
							<td align="left" valign="bottom">
										<!--<input type=checkbox name="All"><strong>All Titles</strong>-->
								<input type="radio" name="All" value="title"><strong>All Titles by Title</strong>&nbsp;&nbsp;
								<input type="radio" name="All" value="subject"><strong>All Titles by Subject</strong>
							</td>
						   </tr>
						   <tr><td align="right" height="30" bgcolor="#FFFFFF">
		...
		<div id="mod2"> 
			<section class="padding">
				...
				<ul>
					<li><a href="index.php" title="Welcome to ECG">Welcome to ECG</a></li>
    				...
    				<li><a href="Student_Games.php" title="Student-Made Games">Student Games</a></li>
		...
		<div id="mod3">
			...
			<i>Get a game made by a John Jay SEA student about learning disabilities.</i>
		</div>
