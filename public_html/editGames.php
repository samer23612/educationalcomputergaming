...
<head>
	...
	<title>Admin Portal - ECG | Edit Game</title>
	...
	<div id="container" style="height:825px;">
		...
		<div id="content" style="color: #00303A; height:725px;">
			...
			$UCurrently_Published = $_POST['Currently_Published'];
				...
				echo ("<h2 style='color: #00303A'>Edit Game Database</h2>");
				}
			...
			if ($id!=NULL) {
				echo 'Submit the fields that you want updated.<br><br>';
				echo '<center>';
				while($database = mysqli_fetch_array($result, MYSQLI_ASSOC)) {    
				?>	
					<FORM METHOD="POST" ACTION="editGames.php" name="search">
										...
										<td align="center" colspan="2">
										  ...
										  <input name="submit" type="submit" value="Update" onclick="editCustomer()">
			 ...
			 ?> </p>
					<script>
						function editCustomer() {
							...
							include_once('connToDB.php');
							$conn = doDB();
								$sqlUpdate = "UPDATE games SET id='" . $Uid . "', title='" . $Utitle . "', publisher='" . $Upublisher . "', description='" . $Udescription . "', website='" . $Uwebsite . "', learningArea='" . $UlearningArea . "', subArea='" . $UsubArea . "', minAgeLevel='" . $UminAgeLevel . "', maxAgeLevel='" . $UmaxAgeLevel . "', minGradeLevel='" . $UminGradeLevel . "', maxGradeLevel='" . $UmaxGradeLevel . "', method='" . $Umethod . "', platform='" . $Uplatform . "', learningNotes='" . $UlearningNotes . "' WHERE id='" . $Uid . "'" ;
